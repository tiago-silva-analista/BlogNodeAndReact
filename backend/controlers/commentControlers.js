...
module.exports = {async index (request,response){
         ...
         const query = 'select * from BPN07917.COMMENTS';
    ...
    async create(request,response){
      ...
      try{
         const query = `INSERT INTO BPN07917.COMMENTS (dsContent, dsAuthor) VALUES ('${request.query.content}','${request.query.author}')`;
         const data = connection.querySync(query);
         console.log(data);      
